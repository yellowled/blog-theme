...
// Navigation
@define('BT_NAV_OPEN', 'Open navigation');
@define('BT_NAV_CLOSE', 'Close navigation');
...
@define('BT_ADAPTIVE_IMAGES', 'JS for adaptive images?');
...
@define('BT_INFOBOX_TITLE_DEFAULT', 'About this blog');
@define('BT_INFOBOX_IMG', 'Info image');
@define('BT_INFOBOX_TXT', 'Info text');
...
// Social media
@define('BT_TWITTER_URL', 'URL to Twitter');
...
@define('BT_AMAZON_URL', 'URL to Amazon');
