...
{if $is_raw_mode != true}
    <header>
        <div class="masthead">
            ...
            <button class="open-nav" type="button" aria-controls="site-nav" aria-label="{$CONST.BT_NAV_OPEN}"><svg class="icon-bars" viewbox="0 0 448 512" width="448" height="512" aria-hidden="true"><use xlink:href="{$serendipityHTTPPath}templates/{$template}/img/sprite.svg#bars"></use></svg></button>
        </div>
    </header>
    ...
    {/if}
        <button class="close-nav" type="button" aria-label="{$CONST.BT_NAV_CLOSE}"><svg class="icon-times" role="img" viewbox="0 0 384 512" width="384" height="512" aria-hidden="true"><use xlink:href="{$serendipityHTTPPath}templates/{$template}/img/sprite.svg#times"></use></svg></button>
    </nav>
