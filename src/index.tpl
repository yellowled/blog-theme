    ...
    <aside id="site-info">
        <div class="sidebar clearfix">
            ...
            <section id="social-media" class="widget">
                ...
                <ul>
                    <li><a href="{$serendipityBaseURL}{$serendipityRewritePrefix}feeds/index.rss2"><svg class="icon-rss" role="img" title="RSS" viewbox="0 0 2048 2048" width="2048" height="2048"><use xlink:href="{$serendipityHTTPPath}templates/{$template}/img/sprite.svg#rss"></use></svg><span class="svg-fallback">RSS</span></a></li>
